...
public class Main {
    ...
    public static void main(String[] args) {
        try (
                Scanner SP = new Scanner(Main.class.getResourceAsStream("bd/VOOBH-SP.txt"));
                Scanner RIO = new Scanner(Main.class.getResourceAsStream("bd/VOOBH-RIO.txt"));
                Scanner BRA = new Scanner(Main.class.getResourceAsStream("bd/VOOBH-BRA.txt"));
    ...
    /**
     * Esse método lê os dados do objeto Scanner e os armazena em um objeto do tipo Voo
     * 
     * 
     * @param scanner
     * @param linesToRead
