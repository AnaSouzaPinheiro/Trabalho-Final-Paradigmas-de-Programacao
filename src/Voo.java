...
public class Voo {
    ...
    String destino, _caminho,_caminhoEspera;
    ...
    public String getCaminho() {
        ...
        switch (num_Voo) {
            case 1:
                caminho = "bd/VOOBH-SP.txt";
                break;
            case 2:                
                caminho = "bd/VOOBH-RIO.txt";
                break;
            case 3:
                caminho = "bd/VOOBH-BRA.txt";
                break;
            default:
    ...
    public String getCaminhoEspera() {
        ...
        switch (num_Voo) {
            case 1:
                caminhoEspera = "bd/ListaEsperaSP.txt";
                break;
            case 2:                
                caminhoEspera = "bd/ListaEsperaRIO.txt";
                break;
            case 3:
                caminhoEspera = "bd/ListaEsperaBRA.txt";
                break;
            default:
